...
type AtendimentoSelecionado = {
  ...
  preferencialOrganizado: boolean | null;
  status: string;
};
...
export default function ProximosAtendimentos() {
  ...
  const atualizarOrganizacao = (atendimentoBelleId: number, dados: { terapeutaNome?: string | null; sala?: string | null; preferencial?: boolean }) => {
    if (!unidadeId) return;
