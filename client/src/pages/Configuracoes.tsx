...
const SECOES = [
  ...
  { chave: "prompts_agentes", label: "Prompts de Agentes", escopo: "global" },
  { chave: "fontes_agentes", label: "Fontes dos Agentes", escopo: "global" },
...
export default function Configuracoes() {
  ...
  return (
    <div className="space-y-6">
      ...
      {(filtroSecao === "todas" || filtroSecao === "prompts_agentes") && <AgentesPromptSection />}

      {(filtroSecao === "todas" || filtroSecao === "fontes_agentes") && <AgentesRecursosSection />}
