...
import { LayoutDashboard, LogOut, PanelLeft, Users, Calendar, KanbanSquare, DollarSign, Sparkles, Image, UserPlus, Settings, MessageCircle, ChevronRight, ScrollText, Repeat, Users2, Loader2, Workflow, Megaphone, AlertTriangle, TableProperties } from "lucide-react";
...
const menuItems: { icon: typeof LayoutDashboard; label: string; path: string; modulo?: ModuloChave; adminOnly?: boolean; children?: { label: string; path: string; subsecao?: string }[] }[] = [
  ...
  { icon: Sparkles, label: "Sugestões IA", path: "/agentes", modulo: "mensagens" },
  { icon: TableProperties, label: "Tabela", path: "/tabela", modulo: "mensagens" },
