...
export default function GlobalSyncCenter() {
  ...
  return <>
    ...
    <Dialog open={isOpen && !isMinimized} onOpenChange={(open) => open ? dispatch({ type: "restore" }) : close()}>
      <DialogContent className="flex h-[92dvh] max-h-[92dvh] max-w-5xl flex-col gap-0 overflow-hidden rounded-2xl p-0 sm:h-auto sm:max-h-[86vh] sm:max-w-5xl">
