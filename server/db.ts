...
export async function upsertClientesImportados(
  ...
  for (const l of linhas) {
    const dadosBase = {
      ...
      celular2: l.celular2 ?? null,
      email: l.email ?? null,
      dataCadastro: l.dataCadastro ?? null,
      primeiroAtendimento: l.primeiroAtendimento ?? null,
      ultimoAtendimento: l.ultimoAtendimento ?? null,
      qtdAtendimentosFinalizados: l.qtdAtendimentosFinalizados ?? 0,
      qtdServicosFinalizados: l.qtdServicosFinalizados ?? 0,
    };
